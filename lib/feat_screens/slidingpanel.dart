          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [
                  const BarIndicator(),
                  CarouselSlider(
                      options: CarouselOptions(autoPlay: false, enableInfiniteScroll: false, aspectRatio: 2.0,
                        disableCenter: true,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        const Text("Metroplaza",
                            style: TextStyle(
                              color: Color.fromARGB(255, 74, 74, 74),
                              fontSize: 16.0,
                            )),
                        const Text("Commercial Building",
                            style: TextStyle(
                              color: Color.fromARGB(255, 189, 187, 187),
                              fontSize: 14.0,
                            )),
                        const Text("Ph.2, Langit Rd., Caloocan, Metro Manila",
                            style: TextStyle(
                              color: Color.fromARGB(255, 189, 187, 187),
                              fontSize: 14.0,
                            )),
                      ...
                      children: <Widget>[
                        OutlinedButton.icon(
                          ...
                          style: OutlinedButton.styleFrom(
                            ...
                            side: BorderSide( color: Color.fromARGB(255, 64,146,210)),
                          ...
                          label: const Text('Contact',style: TextStyle(
                            color: Color.fromARGB(255, 64,146,210),
                            fontSize: 17.0,
                          )),
                        ),
      ...
      child: Column(
        children: [
          ClipRRect(
            ...
            child: FittedBox(
              fit: BoxFit.fill,
              child: Image.asset(imgPath, fit: BoxFit.cover, height: 150, width: 300),
            ),
          ),
        ],
      ),
