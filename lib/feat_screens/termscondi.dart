                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              'refers to Venture, a hybrid application provided by the team Hexagon.\n'),
                      TextSpan(
                          text: '• Team ',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      TextSpan(
                          text:
                              '( referred to as either “The Team”,”We”,”Us” or “Our”) refers to Venture.\n'),
                      TextSpan(
                          text: '• Device ',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      TextSpan(
                          text:
                              'means any device that can access the Service such as a Desktop Computer, a Mobile Phones or a Digital Tablets.\n'),
                      TextSpan(
                          text: '• Personal Data ',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      TextSpan(
                      ...
                      TextSpan(
                          text:
                              'refers to data collected automatically  “Email Details”  either generated by the use of the Service or from the Service infrastructure itself.\n'),
                      TextSpan(
                          text: '• Location Information ',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      TextSpan(
                          text:
                              'means collecting information about your location when you use our services, which helps us offer features like search results for things near you.\n'),
                      TextSpan(
                          text: '• You ',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      TextSpan(
                          text:
                              'mean the individual accessing or using the Service or Application,or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. \n'),
                    ],
                  ),
                ),
              ),
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              'The Venture Terms and Conditions grant you a license to make use of certain features, including those that allow you to:\n'),
                      ...
                      TextSpan(
                          text:
                              'Your observance of the restrictions on use in this license agreement You might not be able to use Venture (or allow those acting on your behalf to do so).\n'),
                      TextSpan(
                          text:
                              '• Create a new product or service based on Venture, or redistribute or sell any portion of Venture.\n'),
                      TextSpan(text: '• Copy the content\n'),
                      TextSpan(
                          text:
                              '• Mass download the content or generate bulk feeds (or permit others to do so);\n'),
                    ],
                  ),
                ),
              ),
              Container(
                  ...
                  child: RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                                text: 'Assumption of Risk: Actual Conditions. ',
                                style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(
                                text:
                                    'Use Venture at your own risk and use the map data, traffic, directions, and other content at your own risk even though actual conditions may differ from the results and content of the map. You are always in charge of your actions and their effects.:\n\n'),
                            TextSpan(
                                text: 'Your Content in Venture: ',
                                style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(
                                text:
                                    'The terms of service for Venture, including the license in the section titled "Permission to use your content," apply to any content you upload, submit, store, send, or receive through Venture. However, since it is not uploaded or submitted to Venture, locally stored content that stays on your device is not covered by this license.\n\n'),
                            TextSpan(
                                text: 'Termination: ',
                                style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              'We use this information to provide features of Our Service, to improve and customize Our Service. The information may be uploaded to the Web Application ”Admin Site” or it may be simply stored on your device.\n'),
                    ],
                  ),
                ),
              ),
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              '• To Manage Your Request: To attend and manage your request to us.\n'),
                      TextSpan(
                          text:
                              '• For other purposes: We may use Your information for other purposes, such as data analysis, identifying usage trends, and to evaluate and improve our services.\n'),
                      TextSpan(
                          text:
                              '• For business transfer: We may share or transfer your personal information in connection with, or during negotiations of,any merger,sale of team assets,financing,or acquisition of all or a portion of Our business to another company.\n'),
                      TextSpan(
                          text:
              ...
              Container(
                  ...
                  child: RichText(
                      text: TextSpan(
                        ...
                        TextSpan(
                            text: 'ucc.venture@gmail.com\n',
                            style: TextStyle(
                              color: Color.fromARGB(255, 31, 182, 223),
                            )),
