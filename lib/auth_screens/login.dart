...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
   ...
   children: [
    ...
    Ink.image(image: AssetImage('assets/images/VentureLogo.png'),
    height: 50
    ),
          ...
          Container(
            child: RawMaterialButton(
              ...
              child: const Text("Forgot Password?",
                  style: TextStyle(color: Color.fromARGB(255, 0, 110, 195), fontSize: 14.0)),
            ),
          ),
                ...
                color: Color.fromARGB(255, 0, 110, 195),
                  ...
                  clipBehavior: Clip.antiAliasWithSaveLayer,
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Ink.image(image: AssetImage('assets/images/google2.png'),
                    height: 40,
                    width: 30
                  ),
                  SizedBox(
                  width: 10.0, height: 50),
    Text('Sign in with Google',  style: TextStyle(color: Colors.white, fontSize: 14.0)),
