...
const Text(''),
Text('Settings',textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Questrial',color: Colors.grey.shade900, fontSize: 22,height: -1,),),
Padding(
...
child: const Text('Save Changes',style: TextStyle(height: 1.5,fontSize: 18),),
...
Image.asset('assets/images/device1.PNG',height: 180,width: 180 ,
),
const Text('Creating and Log-in Account', style: TextStyle(height: 1.5,fontFamily:'Questrial' , fontSize: 20, ),
),
...
Image.asset('assets/images/device2.PNG',height: 200,width: 200 ,
),
const Text('Search and Pin Location', style: TextStyle(height: 1.5,fontFamily:'Questrial' , fontSize: 20, ),
),
